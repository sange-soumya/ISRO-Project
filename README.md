# 🛰️ ISRO Project – Flask GUI Automation Tool
...
## 🧠 Key Features
- 🔹 Upload `.map`, `.lst`, and `.txt` files via a clean Flask UI  
- 🔹 Run backend ADA-based tools automatically using Python `subprocess`  
- 🔹 Generate `.2` output files and provide download options  
- 🔹 Reduce manual command-line operations  
- 🔹 Improve processing accuracy and save time  
...
- **System Tools:** ADA-based Linux utilities (`rrrMMU`, `exe`)
- **Hosting:** Local or internal ISRO server
